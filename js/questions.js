...
'question':'Gguarantee to exporter that the importer of his goods will pay immediately for goods ordered by, is known'
    },
    {
        'correct': 3,
        'content': [
    ...
    {
'question':'When you enter situation without a definite plan of action you are said to be "playing it by" what?',
        'content' : [
            'Fingertips',
            'Ear',
            'Nose',
...
'question':'The escape velocity of rocket fired from the earth towards the moon is the velocity required to overcome'
    },
    {
        'correct': 3,
        'content': [
